      ...
      <header className="sticky top-0 z-50 w-full max-w-full bg-white/90 dark:bg-[#0b0e14]/90 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 transition-colors">
        <div className="w-full max-w-7xl mx-auto px-3 sm:px-6 h-13 sm:h-14 flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
            {/* Navigation Search Button -> Redirect to Community Discovery */}
            <Link
              href="/community"
              className="w-8 h-8 sm:w-9 sm:h-9 rounded-full flex items-center justify-center bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-750 text-slate-700 dark:text-slate-200 border border-slate-300 dark:border-slate-700 transition cursor-pointer shrink-0"
              aria-label="Search & Community Discovery"
              title="Search & Community Discovery"
            >
